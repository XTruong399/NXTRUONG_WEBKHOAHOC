...
<section class="courses" >
    <h2 style="background-color: #af30eb; border-radius: 30px; padding: 5px 0; text-align: center; margin-bottom: 50px; margin: 0 auto; justify-items: center; ">Các khóa học phổ biến</h2>
    <br>
    <br>
    <div class="course-list" >
        ...
        <div class="course">
            ...
            <button class="button" style="height: 40px; width: 100%;">Xem giới thiệu</button>
            ...
            <a href="#">
                <div class="row">
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-8">
                        <div class="image">
                            <img src="{{ asset('public/frontend/images/hinhnodejs.jpg') }}" alt="Blog Image">
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                        <div class="blog-details">
                            <h2>Giới thiệu khóa Nodejs {{ $index }}</h2>
